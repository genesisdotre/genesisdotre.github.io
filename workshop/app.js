...
app.run(function($rootScope) {
  $rootScope.address = "0x38189698a366fe0C4911e8e86a60B3253072C372"; // https://etherscan.io/address/0x38189698a366fe0c4911e8e86a60b3253072c372#code
  ...
  if (typeof web3 !== 'undefined') {
    ...
    web3 = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/hi8olE2lF8OqjyBSdtSm "));
  }

  web3.version.getNetwork((err, network) => {
    if(network === "1") {
      $rootScope.mainnet = true;
    } else {
      $rootScope.mainnet = false;
    }
    $rootScope.$apply();
  });
